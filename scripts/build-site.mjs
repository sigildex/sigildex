...
<section id="status">
  ...
  <p>v0.1.0 is published to npm as <code>sigildex</code> (<code>npm install -g sigildex@0.1.0</code>); the source, the example trees, and the documentation are in the <a href="https://github.com/sigildex/sigildex/blob/main/README.md">repository</a>.</p>
